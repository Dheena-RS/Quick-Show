...
const MovieCard = ({ movie }) => {
    ...
    return (
        <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-2xl hover:-translate-y-1 transition duration-300 w-66'>
            <img referrerPolicy="no-referrer" onClick={() => { navigate(`/movies/${movie._id}`); scrollTo(0, 0) }} src={movie.poster_path} className='rounded-lg w-full aspect-[2/3] object-cover cursor-pointer' />
