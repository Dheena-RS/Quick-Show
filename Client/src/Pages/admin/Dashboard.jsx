...
const Dashboard = () => {
  ...
  return !loading ? (
    ...
    <div className='relative flex flex-wrap gap-4 mt-6'>
        ...
        <div className='flex flex-wrapgap-4 w-full'>
    ...
    <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
        ...
        {dashboardData.activeShows.map((show)=>(
            <div key={show._id} className='w-55 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transition duration-300 cursor-pointer'>
                <img src={image_base_url + show.movie.poster_path} alt='' className='h-69 w-full object-cover' />
