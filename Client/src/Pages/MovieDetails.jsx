  ...
  return show ?(
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        <img src={image_base_url + show.movie.poster_path} className='max-md:mx-auto rounded-xl h-104 max-w-70 object-cover' />
            ...
            {show.movie.vote_average.toFixed(1)} User Rating
              ...
              <p>
                ...
                <div className='flex items-center flex-wrap gap-4 mt-4'>
                  <button className='flex items gap-2 px-7 py-3 text-sm bg-gray-800 hover:bg-gray-900 transition rounded-md font-medium cursur-pointer active:scale-95'>
        ...
        <div className='overflow-x-auto no-scrollbar mt-8 pt-4'>
          <div className='flex items-center gap-4 w-max px-4'>
            {(show.movie.casts || dummyCastsData).slice(0,12).map((cast,index)=>(
